...
while ($true) {
    ...
    if ($exitCode -eq 0) {
        Write-Host "El servidor terminó limpiamente (Exit Code 0). Reiniciando automáticamente en 2 segundos..." -ForegroundColor Cyan
        ...
        Write-Host "Presiona cualquier tecla para volver a iniciarlo, o Ctrl+C para salir definitivamente del bucle..." -ForegroundColor DarkYellow
