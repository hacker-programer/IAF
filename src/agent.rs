...
/// Extrae texto de un XML de documento DOCX (word/document.xml).
/// Busca todos los tags <w:t> y concatena su contenido, separando párrafos con saltos de línea.
